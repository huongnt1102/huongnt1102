...
namespace DichVu.BanGiaoMatBang.Local
{
    public partial class FrmHandover : DevExpress.XtraEditors.XtraForm
    {
            ...
            try
            {
                ...
                gc.DataSource = (from _ in db.ho_ScheduleApartments
                    ...
                    where _.BuildingId == maTn & SqlMethods.DateDiffDay(tuNgay, _.DateHandoverTo) >= 0 &
                          ...
                          (_.StatusId == 2 | _.StatusId == 3 | _.StatusId == 9)
                    select new
                    {
                        _.ApartmentName, _.CustomerName, _.BuildingChecklistName, _.DateHandoverFrom, _.DateHandoverTo,
                        _.Id, _.PlanName, _.IsChoose, _.ScheduleName, _.StatusName, _.UserName, _.DateNumberNotification,cl.Color,_.No,_.NgayDuKienHoanThanh
                    }).ToList();
        ...
        private void gv_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                if (e.Column.FieldName == "StatusName" & gv.GetRowCellValue(e.RowHandle, "Color") !=null)
                {
