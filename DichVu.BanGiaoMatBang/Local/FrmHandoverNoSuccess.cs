...
{
    public partial class FrmHandoverNoSuccess : DevExpress.XtraEditors.XtraForm
    {
        public FrmHandoverNoSuccess()
        {
            InitializeComponent();
        }
        ...
        private void ItemHandoverAllow_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                using (var frm = new FrmHandoverCheckListAllow { Id = (int?)gv.GetFocusedRowCellValue("Id"), BuildingId = (byte)itemToaNha.EditValue, Loai=2 })
                {
                    frm.ShowDialog();
                    if (frm.DialogResult == DialogResult.OK) LoadData();
                }
        ...
        private void itemExportChecklist_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            Commoncls.ExportExcel(gcScheduleApartmentChecklist);
        }
