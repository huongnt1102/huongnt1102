...
namespace DichVu.BanGiaoMatBang.Local
{
    public partial class FrmPlanAllow : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void ItemAllow_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    item.StatusId = 2;
            //    item.StatusName = "Chờ bàn giao nội bộ";

            //    Library.mbMatBang matbang = GetMatBang(item.ApartmentId);
            //    if (matbang != null) matbang.MaTT = 1;
            //}
            ...
            param.Add("@StatusId", 2, System.Data.DbType.Int32, null, null);
            param.Add("@StatusName", "Chờ bàn giao nội bộ", System.Data.DbType.String, null, null);
            param.Add("@MaTT", 1, System.Data.DbType.Int32, null, null);
