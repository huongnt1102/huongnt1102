...
namespace DichVu.BanGiaoMatBang.Customer
{
    public partial class FrmHandoverUser : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void GlkUser_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                count = 0;
                number = int.Parse(item.Properties.View.GetFocusedRowCellValue("NumberCustomer").ToString());
                ...
                var list = _db.ho_ScheduleApartments
                    .Where(_ => _.BuildingId == BuildingId & _.IsChoose == true & _.StatusId == 6 & (_.UserId == null || _.UserId == (int)item.EditValue) & _.ApartmentId!=null).Select(_ => new { _.Id, _.UserId, _.ApartmentName, _.CustomerName, _.DateHandoverFrom, _.DateHandoverTo })
                    .AsEnumerable();
        ...
        private void ItemSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                _db.ho_ScheduleApartments
                    .Where(_ => _.BuildingId == BuildingId & _.IsChoose == true & _.StatusId == 6 &
                ...
                for (var i = 0; i < gv.RowCount; i++)
                {
                    ...
                    //apartmentNames = o.ApartmentName + ", ";
                    SavePlanHistory(o);
                }
        ...
        {
            var noiDung = string.Format("Bạn được {0} giao {1} căn bàn giao khách hàng. Bạn vui lòng kiểm tra.", Library.Common.User.HoTenNV, countApartmentOfUser);
            //var result = Building.AppVime.News.SendNotification.SendEmployee(DichVu.BanGiaoMatBang.Class.Const.TyleNotificationName.GUI_THONG_BAO_APP_KHACH_HANG_CHO_NHAN_VIEN, noiDung, (int)glkUser.EditValue);
            //if (result == true)
            //{
        ...
        private void SaveHistoryNotifycationStaff(string contents)
        {
            _db.ho_NotifycationStaffs.InsertOnSubmit(new Library.ho_NotifycationStaff
            {
                ...
                Contents = contents,
                DateCreate = System.DateTime.UtcNow.AddHours(7),
                IsLocal = false,
                StaffId = (int)glkUser.EditValue,
                StaffName = userName,
                Title = DichVu.BanGiaoMatBang.Class.Const.TyleNotificationName.GUI_THONG_BAO_APP_KHACH_HANG_CHO_NHAN_VIEN,
                TyleId = DichVu.BanGiaoMatBang.Class.Const.TyleNotifycationId.GUI_THONG_BAO_APP_KHACH_HANG_CHO_NHAN_VIEN_ID,
                UserCreateId = Library.Common.User.MaNV,
                UserCreateName = Library.Common.User.HoTenNV
            });
        }
