...
{
    public partial class CtlPanel6 : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void CrlPanel6_Load(object sender, System.EventArgs e)
        {
            ...
            switch (IsView)
                {
                    case false:
                        ...
                        await System.Threading.Tasks.Task.Run(() => LoadControlSetting5());
                        await System.Threading.Tasks.Task.Run(() => LoadControlSetting6());
                    ...
                    default:
                        ...
                        await System.Threading.Tasks.Task.Run(() => LoadControlView5());
                        await System.Threading.Tasks.Task.Run(() => LoadControlView6());
                        break;
                }
        }
        ...
        private async void LoadControlSetting5()
        {
            var ctl = new Building.PhanQuyenBieuDo.ControlSetting.FrmChooseBieuDo { Dock = System.Windows.Forms.DockStyle.Fill, NhomCaiDatId = NhomCaiDatId, SttManHinh = 5 };
            if (panelControl5.InvokeRequired)
                await System.Threading.Tasks.Task.Run(() => { BeginInvoke(new DlgAddItemN(LoadControlSetting5)); });
            else panelControl5.Controls.Add(ctl);
        }

        private async void LoadControlSetting6()
        {
            var ctl = new Building.PhanQuyenBieuDo.ControlSetting.FrmChooseBieuDo { Dock = System.Windows.Forms.DockStyle.Fill, NhomCaiDatId = NhomCaiDatId, SttManHinh = 6 };
            if (panelControl6.InvokeRequired)
                await System.Threading.Tasks.Task.Run(() => { BeginInvoke(new DlgAddItemN(LoadControlSetting6)); });
            else panelControl6.Controls.Add(ctl);
        }
        #endregion
        ...
        private async void LoadControlView5()
        {
            var caiDat = GetCaiDat(5);
            if (caiDat == null) return;
            var control = GetControl(caiDat.ControlId);
            if (control == null) return;
            ...
            controlForm.Dock = System.Windows.Forms.DockStyle.Fill;
            if (panelControl5.InvokeRequired)
                await System.Threading.Tasks.Task.Run(() => { BeginInvoke(new DlgAddItemN(LoadControlView5)); });
            else panelControl5.Controls.Add(controlForm);
        }

        private async void LoadControlView6()
        {
            var caiDat = GetCaiDat(6);
            if (caiDat == null) return;
            var control = GetControl(caiDat.ControlId);
            if (control == null) return;
            ...
            controlForm.Dock = System.Windows.Forms.DockStyle.Fill;
            if (panelControl6.InvokeRequired)
                await System.Threading.Tasks.Task.Run(() => { BeginInvoke(new DlgAddItemN(LoadControlView6)); });
            else panelControl6.Controls.Add(controlForm);
        }
        #endregion
