...
{
    public partial class CtlPanel7 : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void CtlPanel2_Load(object sender, System.EventArgs e)
        {
        ...
        private async void LoadControlView3()
        {
            ...
            var controlForm = (DevExpress.XtraEditors.XtraUserControl)Building.PhanQuyenBieuDo.Class.View.GetControlForm(control.ControlName, control.DllName);
            if (controlForm == null) return;
            controlForm.Dock = System.Windows.Forms.DockStyle.Fill;
            if (panelControl3.InvokeRequired)
