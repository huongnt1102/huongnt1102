...
namespace LandSoftBuilding.Lease.TOS
{
    public partial class frmManager : DevExpress.XtraEditors.XtraForm
    {
        ...
        #region Class
        public class lease_tos_doanhso_load
        {
            ...
            public decimal? TT_TOS { get; set; }

            public decimal? TT_MG { get; set; }

            public decimal? TT_TOS_MG { get; set; }

            public decimal? TT_MF { get; set; }
        ...
        #region Ham xu ly
        // xóa hợp đồng, xóa luôn doanh số
        // fom doanh số, import doanh số ngay trên form doanh số
        // xóa doanh số
        // tạo hóa đơn từ doanh số, maldv  = 2
        ...
        private void Delete()
        {
            ...
            try
            {
                foreach (int i in indexs)
                {
                    ...
                    var ct_ds = db.ctChiTiet_DoanhSos.Where(_ => _.MaHDCT == (int)gvHopDong.GetRowCellValue(i, "ID"));
                    db.ctChiTiet_DoanhSos.DeleteAllOnSubmit(ct_ds);
            ...
            try
            {
                ...
                switch (tabMain.SelectedTabPageIndex)
                {
                    case 0:
                        ...
                        //                        join lgt in db.LoaiGiaThues on ct.MaLG equals lgt.ID into giaThue from lgt in giaThue.DefaultIfEmpty()
                        ...
                        var model = new { MaHD = id};
                        var param = new Dapper.DynamicParameters();
                        param.AddDynamicParams(model);
                        gcChiTiet.DataSource = Library.Class.Connect.QueryConnect.Query<lease_tos_doanhso_load>("lease_tos_doanhso_load_1", param);
