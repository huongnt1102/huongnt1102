...
{
    public partial class rptInLan3 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public string ngayIn1 { set; get; }
        public string thangIn1 { set; get; }
        public string namIn1 { set; get; }

        public string ngayIn2 { set; get; }
        public string thangIn2 { set; get; }
        public string namIn2 { set; get; }
        ...
        public void LoadData()
        {
            ...
            xrTableCell12.Text =
                xrTableCell12.Text.Replace("[CongTyQL]", CongTyQL)
                    ...
                    .Replace("[thangHH]", ThangHH).Replace("[namHH]", NamHH)
                    .Replace("[ngayIn1]", ngayIn1).Replace("[thangIn1]", thangIn1)
                    .Replace("[namIn1]", namIn1).Replace("[ngayIn2]", ngayIn2).Replace("[thangIn2]", thangIn2)
                    .Replace("[namIn2]", namIn2);
        }
    }
}
