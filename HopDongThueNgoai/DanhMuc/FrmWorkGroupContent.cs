...
{
    public partial class FrmWorkGroupContent : XtraForm
    {
        private MasterDataContext _db = new MasterDataContext();
        public FrmWorkGroupContent()
        {
            InitializeComponent();
        }

        private void FrmWorkGroupContent_Load(object sender, EventArgs e)
        {
        ...
        private void LoadData()
        {
            try
            {
                ...
                gc.DataSource = _db.hdctnNhomCongViecContents;
            }
            catch
            {
                //
