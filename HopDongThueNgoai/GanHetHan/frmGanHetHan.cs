...
{
    public partial class frmGanHetHan : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void linqInstantFeedbackSource1_GetQueryable(object sender, DevExpress.Data.Linq.GetQueryableEventArgs e)
        {
            ...
            var denNgay = DateTime.Now.AddDays(Convert.ToInt32(beiNgayHetHan.EditValue));
            ...
            var sql = from p in db.hdctnDanhSachHopDongThueNgoais
                      ...
                      join ncv in db.hdctnNhomCongViecs on p.MaCongViec equals ncv.MaNhomCongViec into nhomCongViec from ncv in nhomCongViec.DefaultIfEmpty()
