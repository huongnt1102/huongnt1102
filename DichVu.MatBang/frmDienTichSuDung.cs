...
{
    public partial class frmDienTichSuDung : DevExpress.XtraEditors.XtraForm
    {
        //private MasterDataContext db;
        List<LtData> ltData = new List<LtData>();

        public frmDienTichSuDung()
        {
            InitializeComponent();
        }
        ...
        void LoadData()
        {
            ...
            try
            {
                ...
                var ltData = Library.Class.Connect.QueryConnect.QueryData<LtData>("bcTyLeLapDay_Chung1", new
                {
