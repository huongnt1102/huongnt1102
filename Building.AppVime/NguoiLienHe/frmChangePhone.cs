    ...
    public partial class frmChangePhone : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnAccept_Click(object sender, EventArgs e)
        {
            ...
            using (var db = new MasterDataContext())
            {
                ...
                if (objOrigin == null)
                {
                    DialogBox.Alert("[Người liên hệ] này không có trong hệ thống.\r\nVui lòng kiểm tra lại, xin cảm ơn.");
                    goto doo;
                }
                    ...
                    if (objCheck != null)
                    {
                        ...
                        else
                        {
                            ...
                            var listCus = (from kh in db.tnKhachHangs
                                           ...
                                           where objOrigin.IsContact.GetValueOrDefault() == true
                                            & nlh.ID == objOrigin.ContactId
                                           select new
                                           {
                                               kh.MaKH,
                                               kh.MaTN,
                            ...
                            {
                                // Cập nhật số điện thoại mới đổi cho người liên hệ trong danh sách khách hàng
                                var itemKhachHang = db.tnKhachHang_NguoiLienHes.FirstOrDefault(_ => _.MaKH == itemObj.ID);
                                if (itemKhachHang != null)
                                {
                                    itemKhachHang.DienThoai = phoneNumber;
                            ...
                            if (toaNhaItems == null)
                            {
                                DialogBox.Alert("[Người liên hệ] này không có tòa nhà.\r\nVui lòng kiểm tra lại, xin cảm ơn.");
                                goto doo;
                            }
