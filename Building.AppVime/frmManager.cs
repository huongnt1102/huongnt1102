    ...
    public partial class frmManager : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void linqInstantFeedbackSource1_GetQueryable(object sender, DevExpress.Data.Linq.GetQueryableEventArgs e)
        {
            try
            {
                ...
                //var a = client.Get("/users/84111222333");
                ...
                e.QueryableSource = from r in db.app_Residents
                                    ...
                                    join mb in db.mbMatBangs on r.SpaceMainId equals mb.MaMB into matBang from mb in matBang.DefaultIfEmpty()
                                    ...
                                    where re.TowerId == maTN
                                        & re.DateOfJoin >= tuNgay
                                        & re.DateOfJoin <= denNgay
                                        & r.IsResident.GetValueOrDefault()
                                    ...
                                    select new
                                    {
                                        ...
                                        IsLogin = r.IsLogin.GetValueOrDefault(),
                                        IsLock = r.IsLock.GetValueOrDefault(),
                                        ResidentId = r.Id,
                                        r.UID,
                                        r.SpaceMainId
                                    };
                ...
                foreach (var i in indexs)
                {
                    ...
                    if (spaceMainId == null)
                    {
                        ...
                        var khachHangItem = (from kh in db.tnKhachHangs
                                  ...
                                  where kh.DienThoaiKH == model.phoneNumber & kh.MaTN == maTN
                                  select new
                                  {
                                      kh.MaKH,
                                      kh.MaTN,
                    ...
                    var khachHang = db.tnKhachHangs.FirstOrDefault(_ => _.MaKH == listCus.MaKH & _.MaTN == maTN);
                    if (khachHang == null)
                    {
                        continue;
                    }
