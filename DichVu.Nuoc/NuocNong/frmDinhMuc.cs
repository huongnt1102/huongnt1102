    ...
    public partial class frmDinhMuc : DevExpress.XtraEditors.XtraForm
    {
        ...
        void LoadData()
        {
            try
            {
                ...
                if (_MaMB != null)
                    gcDinhMuc.DataSource = db.dvNuocNongDinhMucs.Where(p => p.MaMB == _MaMB);
                else if (_MaLMB != null)
                    gcDinhMuc.DataSource = db.dvNuocNongDinhMucs.Where(p => p.MaLMB == _MaLMB & p.MaMB == null);
                else
                    gcDinhMuc.DataSource = db.dvNuocNongDinhMucs.Where(p => p.MaTN == _MaTN & p.MaLMB == null & p.MaMB == null);
            }
            catch
            {
        ...
        void Delete()
        {
            ...
            try
            {
                ...
                {
                    var obj = db.dvNuocNongDinhMucs.Single(p => p.ID == (int)gvDinhMuc.GetRowCellValue(item, "ID"));
                    db.dvNuocNongDinhMucs.DeleteOnSubmit(obj);
                }
                db.SubmitChanges();
