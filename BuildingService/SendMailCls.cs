...
namespace BuildingService
{
    public class SendMailCls
    {
        ...
        {
            get { return BuildingService.Properties.Settings.Default.MailServer; }
            set { _smtpServer = value; }
        }

        private string MailFrom
        {
            get { return BuildingService.Properties.Settings.Default.YourMail; }
        }

        private string PWD
        {
            get { return Commoncls.DecodeString(BuildingService.Properties.Settings.Default.MailPass); }
        }
