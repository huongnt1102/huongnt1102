...
{
    public partial class ctlTKYeuCauTheoMucDo : DevExpress.XtraEditors.XtraUserControl
    {
        tnNhanVien objnhanvien;
        public ctlTKYeuCauTheoMucDo(tnNhanVien obj)
        {
            InitializeComponent();
            objnhanvien = obj;
            LoadKBC();
        ...
        void LoadData()
        {
            if (itemTuNgay.EditValue != null & itemDenNgay.EditValue != null)
            {
                ...
                title.Text = "Thống kê yêu cầu theo độ ưu tiên";
        ...
        private List<ThongKe> LayDSYeuCau(DateTime TuNgay, DateTime DenNgay)
        {
            ...
            {
                var lstTT = db.tnycDoUuTiens.ToList();
                ...
                foreach (var objtt in lstTT)
                {
                    if (objnhanvien.IsSuperAdmin.Value)
                    {
                        ...
                        {
                            TrangThai = objtt.TenDoUuTien,
                            SoLuong = db.tnycYeuCaus
                            .Where(p => p.MaDoUuTien == objtt.MaDoUuTien
