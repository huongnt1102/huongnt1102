...
{
    public partial class ctlThongKeTaiSanTheoToaNha : DevExpress.XtraEditors.XtraUserControl
    {
        public ctlThongKeTaiSanTheoToaNha(tnNhanVien objnhanvien)
        {
            InitializeComponent();
            LoadKBC(objnhanvien);
            LoadData();
        ...
        void LoadKBC(tnNhanVien objnhanvien)
        {
        ...
        private void LoadData()
        {
            if (itemTuNgay.EditValue != null & itemDenNgay.EditValue != null & itemToaNha.EditValue != null)
            {
                ...
                title.Text = "Thống kê tài sản theo Dự án";
        ...
        private List<ThongKe> LayDSTaiSanDangDung(DateTime TuNgay, DateTime DenNgay, byte MaTN)
        {
                ...
                foreach (var objtt in lstTT)
                {
                    ThongKe objtk = new ThongKe()
                    {
                        ...
                        .Where(p => p.MaTT == objtt.MaTT
                            & p.mbMatBang.mbTangLau.mbKhoiNha.tnToaNha.MaTN == MaTN
