...
namespace ListViewComponent {
    public partial class ListViewControl : UserControl
    {
        ...
        public void ChangeAppointment(Appointment apt) {
            ...
            datasource.Add(ListViewDataGenerator.CreateListViewAppointment((AppointmentDataStorage) OwnerScheduler.DataStorage.Appointments, apt, OwnerScheduler.FirstDayOfWeek));
        }
        ...
        private AppointmentBaseCollection GetFilteredAppointments(TimeInterval interval)
        {
            ...
            if (OwnerScheduler.DataStorage.GetAppointments(interval) != null)
            {
                AppointmentBaseCollection aptCollection = OwnerScheduler.DataStorage.GetAppointments(interval);
        ...
        private void InitializeGridControlAppointments()
        {
            ...
            GridControlAppointments.DataSource = ListViewDataGenerator.GenerateListViewAppointmentCollection((AppointmentDataStorage) OwnerScheduler.DataStorage.Appointments, sourceAppointmentCollection, OwnerScheduler.FirstDayOfWeek);
        }
        ...
        private void CreateCustomColorsForStatuses(RepositoryItemImageComboBox riImageComboBox) {
            foreach(AppointmentStatus status in OwnerScheduler.DataStorage.Appointments.Statuses) {
