...
namespace ListViewComponent {
    public static class ListViewDataGenerator {
        public static object GenerateResourcesCollection(SchedulerDataStorage storage)
        {
            return storage.Resources.Items;
        }

        public static object GenerateListViewAppointmentCollection(AppointmentDataStorage storage, AppointmentBaseCollection sourceAppointments, DayOfWeek dayOfWeek)
        {
        ...
        public static ListViewAppointment CreateListViewAppointment(AppointmentDataStorage storage, Appointment sourceAppointment, DayOfWeek dayOfWeek)
        {
