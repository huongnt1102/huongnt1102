...
namespace Building.ServiceAndUtilities.KeHoach
{
    public partial class frmEdit : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            var model = new { id = Id, ma = txtMa.Text, ten = txtTen.Text, tuNgay = dateTuNgay.DateTime, denNgay = dateDenNgay.DateTime, nhanVien = Library.Common.User.MaNV, maTn = MaTN, loai = Loai };
