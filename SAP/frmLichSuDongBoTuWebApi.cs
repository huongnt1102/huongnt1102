...
namespace SAP
{
    public partial class frmLichSuDongBoTuWebApi : DevExpress.XtraEditors.XtraForm
    {
        public System.Collections.Generic.List<SAP.Class.sapEuro_Log> Data { get; set; }

        public frmLichSuDongBoTuWebApi()
        {
            InitializeComponent();
        }
        ...
        void LoadData()
        {
            ...
            try
            {
                ...
                var obj = Library.Class.Connect.QueryConnect.Query<SAP.Class.sapEuro_Log>("sapEuro_Log", param);
                if (obj.Count() > 0)
                {
                    Data = obj.ToList();
                    gc.DataSource = Data;
