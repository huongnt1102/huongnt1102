...
namespace DichVu.YeuCau.DangKyChuyenDo
{
    public partial class frmDangKy : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void LoadData()
        {
            ...
            gridControl1.DataSource = Library.Class.Connect.QueryConnect.Query<dep_dang_ky_thi_cong_get>("tnyc_dang_ky_chuyen_do_get", param);
        }
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            foreach (var i in indexs)
            {
                ...
                Library.Class.Connect.QueryConnect.Query<bool>("dep_dang_ky_chuyen_do_duyet", param);
            }
