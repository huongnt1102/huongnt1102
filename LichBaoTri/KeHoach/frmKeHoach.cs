...
namespace LichBaoTri.KeHoach
{
    public partial class frmKeHoach : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            using (var frm = new frmEdit { MaTN = (byte)itemToaNha.EditValue, Id = 0 })
            {
                frm.ShowDialog();
        ...
        private void ItemSua_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                using (var frm = new frmEdit { MaTN = (byte)itemToaNha.EditValue, Id = (long)gv.GetFocusedRowCellValue("Id") })
                {
                    frm.ShowDialog();
                    if (frm.DialogResult == System.Windows.Forms.DialogResult.OK) LoadData();
                }
