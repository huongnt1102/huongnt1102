...
{
    public partial class CtlBieuDoTongConNo_1 : DevExpress.XtraEditors.XtraUserControl
    {
        /// <summary>
        /// phải thu = phát sinh + nợ đầu kỳ
        /// </summary>
        public CtlBieuDoTongConNo_1()
        {
            InitializeComponent();
        }
        ...
        private System.Collections.Generic.List<chart_tong_da_thu_1> GetHangMucThus()
        {
            ...
            var result = Library.Class.Connect.QueryConnect.Query<chart_tong_da_thu_1>("chart_tong_con_no_1", param);
        ...
        private async void LoadData()
        {
            try
            {
                ...
                chartControl1.Titles[0].Text = "Tổng còn nợ: " + string.Format("{0:n0}", datas.Sum(_ => _.SoTien)) ;
