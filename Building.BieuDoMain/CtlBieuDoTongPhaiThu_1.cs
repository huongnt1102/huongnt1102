...
{
    public partial class CtlBieuDoTongPhaiThu_1 : DevExpress.XtraEditors.XtraUserControl
    {
        /// <summary>
        /// phải thu = phát sinh + nợ đầu kỳ
        /// </summary>
        public CtlBieuDoTongPhaiThu_1()
        {
            InitializeComponent();
        }
        ...
        public class chart_tong_phai_thu_1
        {
        ...
        private System.Collections.Generic.List<chart_tong_phai_thu_1> GetHangMucThus()
        {
            ...
            var result = Library.Class.Connect.QueryConnect.Query<chart_tong_phai_thu_1>("chart_tong_phai_thu_1", param);
        ...
        private async void LoadData()
        {
            try
            {
                ...
                // data
                System.Collections.Generic.List<chart_tong_phai_thu_1> datas = null;
                ...
                chartControl1.Titles[0].Text = "Tổng phát sinh: " + string.Format("{0:n0}", datas.Sum(_ => _.SoTien)) ;

                // tạo series
                var series = new DevExpress.XtraCharts.Series("Tổng phát sinh", DevExpress.XtraCharts.ViewType.Doughnut);
                series.Points.Clear();
