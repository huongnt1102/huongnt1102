...
{
    public partial class CtlSoCanBanGiaoNoiBo : DevExpress.XtraEditors.XtraUserControl
    {
        public CtlSoCanBanGiaoNoiBo()
        {
            InitializeComponent();
        }
