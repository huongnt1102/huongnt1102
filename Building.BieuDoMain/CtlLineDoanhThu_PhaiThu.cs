...
{
    public partial class CtlLineDoanhThu_PhaiThu : DevExpress.XtraEditors.XtraUserControl
    {
        public CtlLineDoanhThu_PhaiThu()
        {
            InitializeComponent();
        }
        ...
        public class chart_doanh_thu_phaithu
        {
        ...
        public class chart_doanh_thu_phaithu_data
        {
            public decimal? SoTien { get; set; }
        ...
        private System.Collections.Generic.List<chart_doanh_thu_phaithu_data> GetHangMucThus()
        {
            ...
            var result = Library.Class.Connect.QueryConnect.Query<chart_doanh_thu_phaithu_data>("chart_doanh_thu_phaithu_data", param);
        ...
        private async void LoadData()
        {
            try
            {
                ...
                System.Collections.Generic.List<chart_doanh_thu_phaithu_data> datas = null;
                ...
                var result_ldv = Library.Class.Connect.QueryConnect.Query<chart_doanh_thu_phaithu>("chart_doanh_thu_phaithu", param_ldv);
