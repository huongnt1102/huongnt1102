...
{
    public partial class CtlDanhSachYeuCauTrongNgayCaNhan : DevExpress.XtraEditors.XtraUserControl
    {
        private Library.MasterDataContext _db = new Library.MasterDataContext();
        public CtlDanhSachYeuCauTrongNgayCaNhan()
        {
            InitializeComponent();
        }
        ...
        #region Danh sách yêu cầu của cá nhân trong ngày
        ...
        private System.Collections.Generic.List<YeuCauTrongNgay> GetYeuCauTrongNgays(string[] ltToaNha, System.DateTime? tuNgay, System.DateTime? denNgay)
        {
            return (from yc in _db.tnycYeuCaus
                    ...
                    where ltToaNha.Contains(yc.MaTN.ToString()) & yc.NgayYC != null & System.Data.Linq.SqlClient.SqlMethods.DateDiffDay(tuNgay, yc.NgayYC.Value) >= 0 & System.Data.Linq.SqlClient.SqlMethods.DateDiffDay(yc.NgayYC.Value, denNgay) >= 0 & yc.MaNTN == Library.Common.User.MaNV
        ...
        private async void LoadData()
        {
            try
            {
                Library.PhanQuyenBieuDo.SaveControl(GetType().Namespace + "." + Name, "Danh sách yêu cầu của cá nhân (trong ngày)", GetType().Namespace + ".dll");
