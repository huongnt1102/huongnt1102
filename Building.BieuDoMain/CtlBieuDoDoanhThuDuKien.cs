...
{
    public partial class CtlBieuDoDoanhThuDuKien : DevExpress.XtraEditors.XtraUserControl
    {
        public CtlBieuDoDoanhThuDuKien()
        {
            InitializeComponent();
        }
            ...
            using(Library.MasterDataContext db = new Library.MasterDataContext())
            {
                return (from ltt in db.ctLichThanhToans
                        ...
                        select new ChartData
                        {
                            MaTn = mb.MaTN,
                            TenTn = tn.TenTN,
                            DoanhThu = ltt.SoTien.GetValueOrDefault()
                        }).ToList();
            }
        }
        ...
        private async void LoadData()
        {
            try
            {
                ...
                // tạo series
                var series = new DevExpress.XtraCharts.Series("Doanh thu dự kiến", DevExpress.XtraCharts.ViewType.Doughnut);
                series.Points.Clear();
