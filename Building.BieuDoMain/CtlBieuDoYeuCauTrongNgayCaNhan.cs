...
{
    public partial class CtlBieuDoYeuCauTrongNgayCaNhan : DevExpress.XtraEditors.XtraUserControl
    {
        public CtlBieuDoYeuCauTrongNgayCaNhan()
        {
            InitializeComponent();
        }

        private void CtlBieuDoYeuCauTrongNgayCaNhan_Load(object sender, System.EventArgs e)
        {
