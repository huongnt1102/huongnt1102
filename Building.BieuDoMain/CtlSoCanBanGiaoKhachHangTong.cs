...
{
    public partial class CtlSoCanBanGiaoKhachHangTong : DevExpress.XtraEditors.XtraUserControl
    {
        public CtlSoCanBanGiaoKhachHangTong()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                using (var db = new MasterDataContext())
                {
                    var status = (from p in db.ho_ScheduleApartments
                                  where ltToaNha.Contains(p.BuildingId.ToString()) & p.IsLocal == false & p.ApartmentId != null
