...
{
    public partial class frmDeXuatThayCa_Manager : XtraForm
    {
        private MasterDataContext _db;

        public frmDeXuatThayCa_Manager()
        {
            InitializeComponent();
        ...
        private void itemDuyetDC_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                if (DialogBox.Question("Bạn muốn duyệt đồng ý thay ca những phiếu này chứ?") == DialogResult.No) return;
