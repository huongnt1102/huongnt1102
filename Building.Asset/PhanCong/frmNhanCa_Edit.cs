...
{
    public partial class frmNhanCa_Edit: XtraForm
    {
        ...
        private void LoadData()
        {
            ...
            repTaiSan.DataSource = _db.tbl_PhanCong_ThietBis.Where(_=>_.SoLuong>0)
        ...
        private void itemLuu_ItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < gvTaiSan.RowCount - 1; i++)
                {
        ...
        private void repTaiSan_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //gvTaiSan.SetFocusedRowCellValue("KyHieu", item.Properties.View.GetFocusedRowCellValue("SoPhieu"));
                gvTaiSan.UpdateCurrentRow();
            }
            catch (Exception)
            {
