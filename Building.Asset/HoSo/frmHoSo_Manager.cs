...
{
    public partial class FrmHoSoManager : XtraForm
    {
        public FrmHoSoManager()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            try
            {
                ...
                if (beiToaNha.EditValue != null && beiTuNgay.EditValue != null && beiDenNgay.EditValue != null)
                {
                    ...
                    //gc.DataSource = db.tbl_HoSos.Where(_ => _.MaTN == (byte) beiToaNha.EditValue & (_.PhanLoaiId == 3 | _.PhanLoaiId == null) & 
                    //                                        SqlMethods.DateDiffDay((DateTime) beiTuNgay.EditValue,
                    //                                            _.NgayNhap) >= 0 &
                    //                                        SqlMethods.DateDiffDay(_.NgayNhap,
                    //                                            (DateTime) beiDenNgay.EditValue) >= 0);
                    gc.DataSource = (from _ in db.tbl_HoSos join cl in db.tbl_HoSo_PhanLoaiDiDens on _.PhanLoaiId equals cl.Id into phanLoai from cl in phanLoai.DefaultIfEmpty() where _.MaTN == (byte)beiToaNha.EditValue & (_.PhanLoaiId == 3 | _.PhanLoaiId == null) & SqlMethods.DateDiffDay((DateTime)beiTuNgay.EditValue, _.NgayNhap) >= 0 & SqlMethods.DateDiffDay(_.NgayNhap, (DateTime)beiDenNgay.EditValue) >= 0 select new { _.ID, _.PhanLoaiName, _.KyHieu, _.Ten, _.NhomHoSoID, _.DienGiai, _.MaMB, _.DayKeID, _.KhanCapID, _.LoaiVanBanID, _.KhoGiayID, _.BaoMatID, _.DuongDan, _.NhanVien, _.NguoiNhap, _.NguoiSua, _.NgayNhap, _.NgaySua, cl.Color }).ToList();
