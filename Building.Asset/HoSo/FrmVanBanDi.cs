...
{
    public partial class FrmVanBanDi : XtraForm
    {
        public FrmVanBanDi()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            try
            {
                ...
                if (beiToaNha.EditValue != null && beiTuNgay.EditValue != null && beiDenNgay.EditValue != null)
                {
                    ...
                    gc.DataSource = (from _ in db.tbl_HoSos join cl in db.tbl_HoSo_PhanLoaiDiDens on _.PhanLoaiId equals cl.Id into phanLoai from cl in phanLoai.DefaultIfEmpty() where _.MaTN == (byte)beiToaNha.EditValue & _.PhanLoaiId == 2 & SqlMethods.DateDiffDay((DateTime)beiTuNgay.EditValue, _.NgayNhap) >= 0 & SqlMethods.DateDiffDay(_.NgayNhap, (DateTime)beiDenNgay.EditValue) >= 0 select new { _.ID, _.PhanLoaiName, _.KyHieu, _.NgayBanHanh, _.TenLoaiVanBan, _.NoiNhan, _.SoTrang, _.SoLuongBan, _.NguoiNhan, _.NguoiKy, _.NguoiDuyet, _.NoiDung, _.DienGiai, cl.Color }).ToList();
