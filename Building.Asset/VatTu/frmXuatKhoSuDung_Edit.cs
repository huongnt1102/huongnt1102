...
{
    public partial class frmXuatKhoSuDung_Edit: XtraForm
    {
        public byte MaTn { get; set; }
        public int? IsSua { get; set; } 
        public long? Id { get; set; } 
        public int? MaNv { get; set; }
        public long? ChiTietTaiSanID { get; set; }
        ...
        private void LoadData()
        {
            ...
            txtDienGiai.Text = "";
            txtMaPhieu.Text = GetMaXuatKho(DateTime.Now);
            ...
            repChiTietTaiSan.DataSource =_db.tbl_ChiTietTaiSans.Where(_ => _.MaTN == MaTn & _.NgungSuDung == false);
        ...
        private string GetMaXuatKho(DateTime ngayPhieu)
        {
            _db = new MasterDataContext();
        ...
        private void gvTaiSan_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            ...
            if (ChiTietTaiSanID != null)
            {
                gvTaiSan.SetFocusedRowCellValue("ChiTietTaiSanID", ChiTietTaiSanID);
            }
        }
