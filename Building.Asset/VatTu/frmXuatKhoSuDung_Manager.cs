...
{
    public partial class frmXuatKhoSuDung_Manager : XtraForm
    {
        private MasterDataContext _db;

        public frmXuatKhoSuDung_Manager()
        {
            InitializeComponent();
        ...
        private void frmManager_Load(object sender, EventArgs e)
        {
            ...
            repChiTietTaiSan.DataSource = _db.tbl_ChiTietTaiSans.Select(_ => new {_.ID, _.TenChiTietTaiSan}).ToList();
            ...
            try
            {
                ...
                if (beiToaNha.EditValue != null && beiTuNgay.EditValue != null && beiDenNgay.EditValue != null)
                {
                    ...
                    gc.DataSource = _db.tbl_VatTu_XuatKhos.Where(_ =>
                        ...
                        SqlMethods.DateDiffDay(_.NgayPhieu, (DateTime)beiDenNgay.EditValue) >= 0 & _.MaTN == (byte)beiToaNha.EditValue&_.LoaiXuatID==1);
                }
            }
            catch
            {
                    ...
                    case "tabLichSu":
                        gcChiTiet.DataSource = (from p in _db.tbl_VatTu_XuatKho_ChiTiets
                            ...
                            select new
                            {
                                ...
                                p.DonGia,p.ThanhTien,p.ChiTietTaiSanID
                            }).ToList();
                        break;
                }
            }
        ...
        private void itemSua_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                using (var frm = new frmXuatKhoSuDung_Edit { MaTn = (byte)beiToaNha.EditValue, IsSua = 1, Id = (long?)gv.GetFocusedRowCellValue("ID") })
                {
                    frm.ShowDialog();
        ...
        private void itemThem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            using (var frm = new frmXuatKhoSuDung_Edit { MaTn = (byte)beiToaNha.EditValue, IsSua = 0, Id = id })
            {
                frm.ShowDialog();
                if (frm.DialogResult == DialogResult.OK) LoadData();
            }
        ...
        private void itemImport_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                using (var frm = new Import.frmXuatKhoSuDung_Import())
                {
