...
{
    public partial class frmBieuDo_TinTucTong : Form
    {
        public frmBieuDo_TinTucTong()
        {
            InitializeComponent();
        }
        ...
        private void LoadData()
        {
            ...
            try
            {
                ...
                using (var db = new MasterDataContext())
                {
                    ...
                    var strTitle = string.Format("TỔNG PHẢN ÁNH TỪ {0:MM/yyyy} ĐẾN {1:MM/yyyy}", tuNgay, denNgay);
