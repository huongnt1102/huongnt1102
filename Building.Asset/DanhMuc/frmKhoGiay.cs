...
{
    public partial class frmKhoGiay : XtraForm
    {
        ...
        private void frmKhoGiay_Load(object sender, EventArgs e)
        {
        ...
        private void LoadData()
        {
            ...
            gc.DataSource = _db.tbl_HoSo_KhoGiays;
        }
        ...
        private void itemXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var obj = _db.tbl_HoSo_KhoGiays.FirstOrDefault(_ => _.ID == (int) gv.GetFocusedRowCellValue("ID"));
                if (obj != null)
                {
                    _db.tbl_HoSo_KhoGiays.DeleteOnSubmit(obj);
                }
