...
{
    public partial class frmPhanCong_PLT : XtraForm
    {
        private MasterDataContext _db;

        public frmPhanCong_PLT()
        {
            InitializeComponent();
        }
        ...
        private void LoadData()
        {
            ...
            gridControl.DataSource = _db.tbl_PhanCong_PhanLoaiThaps;
        }
        ...
        private void barButtonItemXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var obj = _db.tbl_PhanCong_PhanLoaiThaps.FirstOrDefault(_ => _.ID == (int) gridView.GetFocusedRowCellValue("ID"));
                if (obj != null)
                {
                    _db.tbl_PhanCong_PhanLoaiThaps.DeleteOnSubmit(obj);
                }
        ...
        {
            var tenVietTat = gridView.GetFocusedRowCellValue("Name");
            if (tenVietTat == null)
            {
                e.ErrorText = "Vui lòng nhập tên name!";
                e.Valid = false;
                return;
            }

            if (IsDuplication("Name", e.RowHandle, tenVietTat.ToString()))
            {
