...
{
    public partial class frmDanhMucHoSo : XtraForm
    {
        private MasterDataContext _db;

        public frmDanhMucHoSo()
        {
            InitializeComponent();
        }

        private void frmDanhMucHoSo_Load(object sender, EventArgs e)
        {
        ...
        private void LoadData()
        {
            ...
            gc.DataSource = _db.tbl_HoSo_NhomHoSos;
        }
        ...
        private void itemXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var obj = _db.tbl_HoSo_NhomHoSos.FirstOrDefault(_ => _.ID == (int) gv.GetFocusedRowCellValue("ID"));
                if (obj != null)
                {
                    _db.tbl_HoSo_NhomHoSos.DeleteOnSubmit(obj);
                }
        ...
        private void gv_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            {
                e.ErrorText = "Ký hiệu danh mục hồ sơ này đã có";
                e.Valid = false;
