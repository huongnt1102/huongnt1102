...
{
    public partial class frmDoKhanCap : XtraForm
    {
        ...
        private void frmDoKhanCap_Load(object sender, EventArgs e)
        {
        ...
        private void LoadData()
        {
            ...
            gc.DataSource = _db.tbl_HoSo_DoKhanCaps;
        }
        ...
        private void itemXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var obj = _db.tbl_HoSo_DoKhanCaps.FirstOrDefault(_ => _.ID == (int) gv.GetFocusedRowCellValue("ID"));
                if (obj != null)
                {
                    _db.tbl_HoSo_DoKhanCaps.DeleteOnSubmit(obj);
                }
        ...
        private void gv_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            if (tenVietTat == null)
            {
                e.ErrorText = "Vui lòng nhập ký hiệu độ khẩn cấp";
                e.Valid = false;
                return;
            }
            ...
            {
                e.ErrorText = "Ký hiệu Độ khẩn cấp này đã có";
                e.Valid = false;
