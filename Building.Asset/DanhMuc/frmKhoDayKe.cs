...
{
    public partial class frmKhoDayKe : XtraForm
    {
        ...
        private void frmDayKe_Load(object sender, EventArgs e)
        {
        ...
        private void LoadData()
        {
            ...
            gc.DataSource = _db.tbl_HoSo_DayKes;
        }
        ...
        private void itemXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var obj = _db.tbl_HoSo_DayKes.FirstOrDefault(_ => _.ID == (int) gv.GetFocusedRowCellValue("ID"));
                if (obj != null)
                {
                    _db.tbl_HoSo_DayKes.DeleteOnSubmit(obj);
                }
        ...
        private void gv_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            if (tenVietTat == null)
            {
                e.ErrorText = "Vui lòng nhập tên dãy (kệ)";
                e.Valid = false;
                return;
            }
            ...
            {
                e.ErrorText = "Ký hiệu Dãy (Kệ) này đã có";
                e.Valid = false;
