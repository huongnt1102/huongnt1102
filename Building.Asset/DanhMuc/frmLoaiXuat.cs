...
{
    public partial class frmLoaiXuat : XtraForm
    {
        ...
        private void frmLoaiXuat_Load(object sender, EventArgs e)
        {
        ...
        private void LoadData()
        {
            ...
            gc.DataSource = _db.tbl_VatTu_XuatKho_LoaiXuats;
        }
        ...
        private void gv_InitNewRow(object sender, DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs e)
        {
            ...
            gv.SetFocusedRowCellValue("NgungSuDung", false);
        }
        ...
        private void itemXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var obj = _db.tbl_VatTu_XuatKho_LoaiXuats.FirstOrDefault(_ => _.ID == (int) gv.GetFocusedRowCellValue("ID"));
                if (obj != null)
                {
                    _db.tbl_VatTu_XuatKho_LoaiXuats.DeleteOnSubmit(obj);
                }
        ...
        {
            var tenVietTat = gv.GetFocusedRowCellValue("Ten");
            if (tenVietTat == null)
            {
