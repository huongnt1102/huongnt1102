...
{
    public partial class frmMucDoBaoMat : XtraForm
    {
        private MasterDataContext _db;

        public frmMucDoBaoMat()
        {
            InitializeComponent();
        }

        private void frmMucDoBaoMat_Load(object sender, EventArgs e)
        {
        ...
        private void LoadData()
        {
            ...
            gc.DataSource = _db.tbl_HoSo_MucDoBaoMats;
        }
        ...
        private void itemXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var obj = _db.tbl_HoSo_MucDoBaoMats.FirstOrDefault(_ => _.ID == (int) gv.GetFocusedRowCellValue("ID"));
                if (obj != null)
                {
                    _db.tbl_HoSo_MucDoBaoMats.DeleteOnSubmit(obj);
                }
