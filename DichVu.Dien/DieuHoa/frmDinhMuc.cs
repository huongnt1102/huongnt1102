    ...
    public partial class frmDinhMuc : DevExpress.XtraEditors.XtraForm
    {
        ...
        void LoadData()
        {
            try
            {
                ...
                if (_MaMB != null)
                    gcDinhMuc.DataSource = db.dvDienDH_DinhMucs.Where(p => p.MaMB == _MaMB);
                else if (_MaLMB != null)
                    gcDinhMuc.DataSource = db.dvDienDH_DinhMucs.Where(p => p.MaLMB == _MaLMB & p.MaMB == null);
                else
                    gcDinhMuc.DataSource = db.dvDienDH_DinhMucs.Where(p => p.MaTN == _MaTN & p.MaLMB == null & p.MaMB == null);
            }
            catch
            {
