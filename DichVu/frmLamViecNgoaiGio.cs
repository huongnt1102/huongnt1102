...
namespace DichVu
{
    public partial class frmLamViecNgoaiGio : XtraForm
    {
        public frmLamViecNgoaiGio()
        {
            InitializeComponent();
        }
        ...
        void LoadData()
        {
            var data = (from dk in db.tnLamViecNgoaiGios
                        ...
                        select new
                        {
                            ...
                            mb.MaMB,
                            SoMatBang = mb.MaSoMB,
                            GhiChu = dk.ChiTietDeNghi,
                            NgayTaoPhieu = dk.NgayTao,
                            Duyet = dk.Duyet == true ? "Đã duyệt" : "Chưa duyệt",
        ...
        private void frmLamViecNgoaiGio_Load(object sender, EventArgs e)
        {
        ...
        private void itemXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (ID != null)
            {
                ...
                {
                    var check = db.tnLamViecNgoaiGios.SingleOrDefault(p => p.ID == ID);
                    if (check != null)
                    {
                        db.tnLamViecNgoaiGios.DeleteOnSubmit(check);
                        db.SubmitChanges();
                        LoadData();
                    }
                }
        ...
        private void btnDuyet_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (ID != null)
            {
                frmDuyetYeuCauNgoaiGio frm = new frmDuyetYeuCauNgoaiGio();
                frm.IDToaNha = matn;
                frm.ID = ID;
                frm.ShowDialog();
                LoadData();
