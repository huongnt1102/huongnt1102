...
namespace DichVu
{
    public partial class frmBaoGiaSC : XtraForm
    {
        ...
        void LoadDetail()
        {
            ...
            if (obj.Count > 0)
            {
                foreach (var item in obj)
                {
                    ...
                    gvChiTiet.SetRowCellValue(GridControl.NewItemRowHandle, "SoLuong", item.SoLuong);
                    ...
                    gvChiTiet.SetRowCellValue(GridControl.NewItemRowHandle, "BQLGhiChu", item.BQLGhiChu);
        ...
        private void initTable()
        {
            ...
            dt1.Columns.Add(new DataColumn("BQLGhiChu", typeof(string)));
            dt1.Columns.Add(new DataColumn("STT", typeof(string)));
            gcChiTiet.DataSource = dt1;
        }

        private void frmBaoGiaSC_Load(object sender, EventArgs e)
        {
            LoadDetail();
        }
        ...
        private void btnSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                for (int i = 0; i < gvChiTiet.RowCount - 1; i++)
                {
                    ...
                    var DonGia = (decimal)gvChiTiet.GetRowCellValue(i, "DonGia");
                    ...
                    var GhiChu = gvChiTiet.GetRowCellValue(i, "BQLGhiChu");
                    if (IDC != null)
                    {
                ...
                if (check != null)
                {
                    ...
                    check.BQLTraLoi = "Kính gửi (anh/chị) báo giá phí sửa chữa";
                    check.NVQLTraLoi = Common.User.MaNV;
                    db.SubmitChanges();
                }
                this.Close();
            }
            ...
            using (var db = new MasterDataContext())
            {
                try
                {
                    ...
                    body.bqlTraLoi = "Kính gửi (anh/chị) báo giá phí sửa chữa";
        ...
        private void spinTienVAT_EditValueChanged(object sender, EventArgs e)
        {
            gvChiTiet.SetFocusedRowCellValue("TienVAT", ((SpinEdit)sender).Value);
            TinhThanhTien();
        }

        private void spinTyLeCK_EditValueChanged(object sender, EventArgs e)
        {
            gvChiTiet.SetFocusedRowCellValue("TyLeCK", ((SpinEdit)sender).Value);
            TinhThanhTien();
        }

        private void spinTienCK_EditValueChanged(object sender, EventArgs e)
        {
