    ...
    public partial class frmManager : DevExpress.XtraEditors.XtraForm
    {
        ...
        void LoadData()
        {
            ...
            if (itemTuNgay.EditValue != null && itemDenNgay.EditValue != null)
            {
                ...
                {
                    gcDinhMuc.DataSource = db.dvLaiSuats
                        ...
                        .Select((p, index) => new
                        {
                            ...
                            //p.TuNgay,
                            //p.DenNgay,
                            //IsByMonth = p.IsByMonth.GetValueOrDefault(),
                            //p.tnToaNha.TenTN,
                            //p.LaiSuat,
        ...
        void DeleteSelected()
        {
            ...
            try
            {
                List<dvLaiSuat> lst = new List<dvLaiSuat>();
                foreach (int i in indexs)
                {
                    dvLaiSuat objNK = db.dvLaiSuats.Single(p => p.ID == (int)grvDinhMuc.GetRowCellValue(i, "ID"));
                    lst.Add(objNK);
                }
                db.dvLaiSuats.DeleteAllOnSubmit(lst);
                db.SubmitChanges();
