...
{
    public partial class FrmCongNoDichVu : XtraForm
    {
        public FrmCongNoDichVu()
        {
            InitializeComponent();
        }
        ...
        void LoadData()
        {
            ...
            try
            {
                ...
                //               where ltToaNha.Contains(hd.MaTN) & SqlMethods.DateDiffDay(hd.NgayTT, _TuNgay) > 0 & hd.IsDuyet == true//& hd.MaKH == 3108
                ...
                //               where ltToaNha.Contains(sq.MaTN) & SqlMethods.DateDiffDay(sq.NgayPhieu, _TuNgay) > 0 & sq.MaLoaiPhieu != 24 //& hd.MaKH == 3108
                ...
                //                  where ltToaNha.Contains(hd.MaTN) & SqlMethods.DateDiffDay(_TuNgay, hd.NgayTT) >= 0 //& hd.MaKH == 3108
                ...
                //                         join hd in db.dvHoaDons on new { ct.TableName, ct.LinkID } equals new { TableName = "dvHoaDon", LinkID = (long?)hd.ID } into hoaDon
                //                         from hd in hoaDon.DefaultIfEmpty() // đoạn này mới thêm vào
                //                         where ltToaNha.Contains(ct.MaTN)
                //                         & SqlMethods.DateDiffDay(_TuNgay, ct.NgayPhieu) >= 0
                //                         & SqlMethods.DateDiffDay(ct.NgayPhieu, _DenNgay) >= 0
                //                         & ct.LinkID == null && ct.MaLoaiPhieu != 24
                //                         group ct by new { ct.MaTN, ct.MaKH, hd.MaMB } into gr
                //                         select new TKCongNoCls
                //                         {
                //                             KyBC = "3. Đã thu",
                //                             MaTN = gr.Key.MaTN,
                ...
                //                  where ltToaNha.Contains(ct.MaTN)// & ct.MaKH == 3108
                ...
                //             where ltToaNha.Contains(kh.MaTN)// & kh.MaKH == 3108
                //             select new
                //             {
                //                 kh.MaKH,
                //                 kh.KyHieu,
        ...
        private void ItemCapNhatPhieuThu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
