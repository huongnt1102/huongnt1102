...
{
    public partial class rptGiayBaoThangLong : DevExpress.XtraReports.UI.XtraReport
    {
        byte MaTN;
        int MaKH, Thang, Nam;

        public rptGiayBaoThangLong(byte _MaTN, int _Thang, int _Nam, int _MaKH, List<int> _MaLDVs, int _MaTKNH)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                switch (_MaLDV)
                {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        rptDichVu.ReportSource = new rptTheXeThangLong(this.MaTN, this.MaKH, this.Thang, this.Nam);
                        break;
                    case 8:
