...
{
    public partial class rptGiayBaoImperiaNuoc : DevExpress.XtraReports.UI.XtraReport
    {
        byte MaTN;
        int MaKH, Thang, Nam;

        public rptGiayBaoImperiaNuoc(byte _MaTN, int _Thang, int _Nam, int _MaKH, List<int> _MaLDVs, int _MaTKNH)
        {
            InitializeComponent();
            ...
            try
            {
                Library.frmPrintControl.LoadLayout(this, 94, _MaTN);
            ...
            try
            {
                ...
                switch (_MaLDV)
                {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        rptDichVu.ReportSource = new rptTienNuocImperiaCH(this.MaTN, this.MaKH, this.Thang, this.Nam);
                        break;
                    case 10:
