...
{
    public partial class rptTienDienThangLong : DevExpress.XtraReports.UI.XtraReport
    {
        public rptTienDienThangLong(byte _MaTN, int _MaKH, int _Thang, int _Nam)
        {
            InitializeComponent();
            ...
            cTongTienDien.DataBindings.Add("Text", null, "TongTien", "{0:#,0.##}");
            #endregion
            ...
            try
            {
                this.DataSource = (from hd in db.dvHoaDons
                                   ...
                                   select new
                                   {
                                       ...
                                       td.ChiSoCu,
                                       td.ChiSoMoi,
                                       SoTieuThu=td.SoTieuThu+td.SoTieuThuDHCu.GetValueOrDefault(),
