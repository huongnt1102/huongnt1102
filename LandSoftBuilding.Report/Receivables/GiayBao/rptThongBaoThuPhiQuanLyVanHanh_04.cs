...
{
    public partial class RptThongBaoThuPhiQuanLyVanHanh04 : XtraReport
    {
        public RptThongBaoThuPhiQuanLyVanHanh04(byte maTn, int maKh, int thang, int nam, int _MaTKNH)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                {
                    cBanQuanLyKhuDanCu.Text = "BAN QUẢN LÝ KHU DÂN CƯ " + objTn.TenTN;
                    ...
                    var list = (from hd in db.dvHoaDons
                                ...
                                & hd.IsDuyet == true
                                      & (hd.ConNo != 0 & l.ID == 13 & dvk.MaLDV == 13)

                                orderby hd.NgayTT descending
                                select new
                                {
                                    MaDichVu = l.ID,
                                    DienTichNen = mb.DienTich,
                                    MaSoMB=mb.MaSoMB,
                                    DonGia = dvk.DonGia,
