...
{
    public partial class rptDichVuCoBanTTC : DevExpress.XtraReports.UI.XtraReport
    {
        public rptDichVuCoBanTTC(byte _MaTN, int _MaKH, int _Thang, int _Nam, int _MaLDV)
        {
            InitializeComponent();
