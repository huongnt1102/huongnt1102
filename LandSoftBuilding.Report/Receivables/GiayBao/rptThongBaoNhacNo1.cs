...
{
    public partial class rptThongBaoNhacNo1 : DevExpress.XtraReports.UI.XtraReport
    {
        public rptThongBaoNhacNo1(byte _MaTN, int _Thang, int _Nam, int _MaKH,int _MaMB, List<int> _MaLDVs, int _MaTKNH)
        {
            InitializeComponent();
            Library.frmPrintControl.LoadLayout(this, 91, _MaTN);
