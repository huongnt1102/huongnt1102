...
{
    public partial class rptHopDongThueKho : DevExpress.XtraReports.UI.XtraReport
    {
        public rptHopDongThueKho(int? MaHD)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                ctlRTF.Document.ReplaceAll("[ThoiGianThue]", string.Format("{0} tháng (Từ ngày {1:dd/MM/yyyy} đến ngày {2:dd/MM/yyyy}", objHD.ThoiHan, objHD.NgayHL, objHD.NgayHH), SearchOptions.None);
