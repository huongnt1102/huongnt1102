...
{
    public partial class rptThongBaoThanhToanMau2 : DevExpress.XtraReports.UI.XtraReport
    {
        public rptThongBaoThanhToanMau2(int? MaHD, byte _MaTN)
        {
            Library.frmPrintControl.LoadLayout(this, 77, _MaTN);
