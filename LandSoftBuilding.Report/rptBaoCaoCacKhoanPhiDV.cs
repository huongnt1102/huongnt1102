...
{
    public partial class rptBaoCaoCacKhoanPhiDV : DevExpress.XtraReports.UI.XtraReport
    {
        DateTime _TuNgay;
        private DateTime _DenNgay;
        private string strTN;
        public rptBaoCaoCacKhoanPhiDV(DateTime TuNgay, DateTime DenNgay, string str)
        {
            InitializeComponent();
            _TuNgay = TuNgay;
            _DenNgay = DenNgay;
            ...
            var rpt = new SubrptBaoCaoCacKhoanPhiDV();
            ...
            cTienDienDH.DataBindings.Add("Text", null, "DienDH", "{0:#,0.##}");
            cTienDienDH.DataBindings.Add("Text", null, "DienDH", "{0:#,0.##}");
            //cDT
            ...
            cSumCongTyTienDienDH.DataBindings.Add("Text", null, "DienDH", "{0:#,0.##}");
            cSumCongTyTienDienDH.Summary = new XRSummary(SummaryRunning.Group, SummaryFunc.Sum, "{0:#,0.##}");
            //------------------------------------------------------------
            ...
            cSumTienDienDH.DataBindings.Add("Text", null, "DienDH", "{0:#,0.##}");
            cSumTienDienDH.Summary = new XRSummary(SummaryRunning.Report, SummaryFunc.Sum, "{0:#,0.##}");
            cSumTienDienDH.DataBindings.Add("Text", null, "DienDH", "{0:#,0.##}");
            cSumTienDienDH.Summary = new XRSummary(SummaryRunning.Report, SummaryFunc.Sum, "{0:#,0.##}");

            TongPhaiThu.DataBindings.Add("Text", null, "SoTienPhaiThu", "{0:#,0.##}");
            TongPhaiThu.Summary = new XRSummary(SummaryRunning.Report, SummaryFunc.Sum, "{0:#,0.##}");
            TongDaThu.DataBindings.Add("Text", null, "SoTienDaThu", "{0:#,0.##}");
            TongDaThu.Summary = new XRSummary(SummaryRunning.Report, SummaryFunc.Sum, "{0:#,0.##}");
            TongConPhaiThu.DataBindings.Add("Text", null, "PhaiThuConLai", "{0:#,0.##}");
            TongConPhaiThu.Summary = new XRSummary(SummaryRunning.Report, SummaryFunc.Sum, "{0:#,0.##}");
            ...
            try
            {
                ...
                var DK = (from hd in db.dvHoaDons
                          where ltToaNha.Contains(hd.MaTN) & SqlMethods.DateDiffDay(hd.NgayTT, _TuNgay) > 0 & hd.IsDuyet == true
                            ...
                            & (hd.MaLDV == 35 | hd.MaLDV == (int)MaLDVs.Nuoc | hd.MaLDV == (int)MaLDVs.PGX | hd.MaLDV == (int)MaLDVs.Dien | hd.MaLDV == 30)
                ...
                var PhaiThu = (from hd in db.dvHoaDons
                               ...
                               select new
                               {
                                   ...
                                   DienDH = gr.Sum(p => p.MaLDV == 11 & SqlMethods.DateDiffMonth(_TuNgay, p.NgayTT) == 0 ? p.PhaiThu : 0),
                ...
                this.DataSource = (from hd in ltData
                                   ...
                                   select new
                                   {
                                       ...
                                       DienDH = gr.Sum(p => p.hd.Xe) == 0 ? null : gr.Sum(p => p.hd.DienDH),
        ...
        private void xrSubreport1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            var id = strTN;
            var rpt = xrSubreport1.ReportSource as SubrptBaoCaoCacKhoanPhiDV;
            rpt.LoadData(id,_TuNgay,_DenNgay);
        }
